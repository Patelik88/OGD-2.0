...
<head>
    ...
    <link rel="shortcut icon" href="/img/favicon-x.png" type="image/x-icon"/>
...
<main class="haupt">
    <div class="container my-4">
        ...
        <div id="sendsuccess" class="col-md-12" align="center" style="display: none;">
            <p>Vielen Dank für Ihre Nachricht!</p>
            <form action="index.php">
                <button type="submit" class="btn btn-success btn-bottom">Zurück zur Karte</button>
            </form>
        </div>
    </div>
</main>
